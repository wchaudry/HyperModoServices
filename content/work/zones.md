...
inuse:
  ...
  sub: "Each one a quarterly increment that reached the business while the core platform went in underneath."
  items:
    - { tag: "pricing", title: "Competitive price analysis", text: "Pricing coverage across the catalog instead of a small subset of SKUs." }
    - { tag: "identity", title: "One login for customers and partners", text: "Single sign-on across every Zones application." }
    - { tag: "catalog", title: "Vendor feed processing", text: "Daily vendor feeds taken in, validated and processed automatically." }
    - { tag: "orders", title: "Global order approvals", text: "One way, worldwide, for customers to handle purchase-order approvals." }
record:
  eyebrow: "The record"
